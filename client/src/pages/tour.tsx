...
const SLIDES = [
  ...
  {
    id: "event_owner",
    tag: "For Event Owners",
    title: "Run Your Markets with Confidence",
    subtitle: "VendorGrid Pro gives you everything to organize, promote, and manage artisan markets and pop-up events.",
    bg: "from-orange-50 to-amber-50 dark:from-orange-950/30 dark:to-amber-950/20",
    accent: "text-primary",
    iconBg: "from-primary to-amber-500",
    icon: Store,
    features: [
      { icon: CalendarCheck, text: "Create and publish unlimited multi-day events with custom dates and descriptions" },
      { icon: ClipboardList, text: "Set vendor space counts and let vendors apply or register directly" },
      { icon: CreditCard, text: "Accept vendor registration payments via Square or Stripe Connect" },
      { icon: BarChart3, text: "View analytics: attendance trends, repeat vendors, and filled spaces" },
      { icon: Bell, text: "Send push notifications to Pro vendors in your event's area" },
      { icon: MapPin, text: "Build an interactive vendor map to track and assign spots" },
    ],
    proBadge: "VendorGrid Pro — $14.95/mo",
  ...
  },
  {
    ...
    subtitle: "VendorGrid Pro lets you discover events, secure vendor spaces, and showcase your products to eager customers.",
    ...
    features: [
      ...
      { icon: Ticket, text: "Register for vendor spaces — no platform fees for Pro members" },
      { icon: ShoppingBag, text: "Post a vendor card with up to 10 product photos per event" },
      { icon: BarChart3, text: "Track inventory brought and sold at every event you attend" },
      { icon: MessageSquare, text: "Message event owners directly to ask questions or coordinate" },
  ...
  },
  {
    ...
    subtitle: "Community access is always free. VendorGrid Pro unlocks everything — for owners and vendors alike — in one simple plan.",
