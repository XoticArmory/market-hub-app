        ...
        <DialogContent className="max-w-2xl rounded-3xl">
          ...
          <div className="flex items-start gap-3 mt-2">
            ...
            <label htmlFor="terms-accept" className={`text-sm ${!termsScrolled ? 'text-muted-foreground' : 'text-foreground'}`}>
              I have read and agree to the VendorGrid Pro Terms of Service.
            </label>
          </div>
          <div className="flex gap-3 mt-2">
            ...
            >
              {isCheckingOut ? <><Loader2 className="w-4 h-4 mr-2 animate-spin" />Redirecting...</> : "Accept & Continue to Payment"}
            </Button>
          </div>
          <p className="text-xs text-center text-muted-foreground flex items-center justify-center gap-1">
            <ShieldCheck className="w-3 h-3" /> Secured by Stripe · Cancel anytime from your profile
          </p>
        </DialogContent>
      </Dialog>
    </div>
