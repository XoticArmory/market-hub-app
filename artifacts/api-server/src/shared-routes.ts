...
export const api = {
  ...
  events: {
    ...
    create: { method: 'POST' as const, path: '/api/events' as const, input: insertEventSchema.extend({ date: z.coerce.date(), extraDates: z.array(z.string()).optional(), notifyMessage: z.string().max(160).optional() }), responses: { 201: z.any() } },
